...
PHONE_HONESTY = (
    ...
    "(WHITEPAGES_API_KEY) or Trestle Reverse Phone (TRESTLE_API_KEY) may "
    "return owner names and addresses when those APIs have them — missing "
    "fields stay empty. Use the labeled reverse-lookup "
